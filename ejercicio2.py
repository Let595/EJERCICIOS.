...
1.4 Crea un diccionario llamado "producto" que tenga las claves "nombre", "precio" y "cantidad". Asigna valores a estas claves y luego muestra el diccionario completo por consola.
'''
persona = {"nombre": "Juan", "edad": 10}
persona['edad'] = 30
print(persona['edad'])
